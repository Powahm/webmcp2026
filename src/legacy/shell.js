...
export const Desk = (() => {
  ...
  function openWindow({ id, title, meta = "", tint, size = { w: 560, h: 440 }, minSize, centered = false, origin, build, onClose }) {
    ...
    const rec = { el, id, title, tint, minSize, restore: null, onClose, cleanups: [], visibility: [] };
    windows.set(id, rec);
